	...
	public static void main(String[] args) {
		...
		while (!quit) {
			...
			case 6:
				Hex.setInput();
				if(Hex.greaterThan()){
					System.out.println("Hex number1: " + Hex.geth1() + " is greater than hex number2: "+ Hex.geth2());
				}else{
					System.out.println("Hex number1: " + Hex.geth1() + " is not greater than hex number2: "+ Hex.geth2());
				}
				break;
			case 7:
				Hex.setInput();
				if(Hex.lessThan()){
					System.out.println("Hex number1: " + Hex.geth1() + " is less than hex number2: "+ Hex.geth2());
				}else{
					System.out.println("Hex number1: " +Hex.geth1() + " is not less than hex number2: "+ Hex.geth2());
				}
				break;
			case 8:
				int decVal=0;

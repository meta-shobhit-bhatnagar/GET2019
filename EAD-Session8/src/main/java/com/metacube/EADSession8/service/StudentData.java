...
public class StudentData {
	...
	public List<StudentCommands> getAllStudent(){
		StudentCommands s1 = new StudentCommands(25,"Vatsal","Sharma","Kailash Chand Sharma","vatsal.sharma1@metacube.com","12","16");
		studentList.add(s1);
		StudentCommands s2 = new StudentCommands(26,"Shobhit","Bhatnagar","Vinod kumar","shobhit@metacube.com","11","16");
		studentList.add(s2);

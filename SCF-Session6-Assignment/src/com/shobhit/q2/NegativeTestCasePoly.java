 ...
 *
 */
public class NegativeTestCasePoly {
	...
	assertEquals(50.0,ans,0.00);			//evaluates if value of polynomial is equal to expected value
	}
	...
	int[][] expectedArr= {{0,1,2,3},{1, 9, 10, 4}}; 		//correct answer should be {0,1,2,3},{1, 9, 9, 4}
...
//	p1.multiplyPoly(p1, p2);
	...
	int[][] expectedArr= {{1,2,3,4,5},{10,20,33,12,24}};   			//correct output should be {1,2,3,4,5},{7,20,33,46,24}
